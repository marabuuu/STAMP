    ...
    match args.command:
        ...
        case "preprocess":
            ...
            extract_(
                ...
                channel_order=config.preprocessing.channel_order,
                dapi_index=config.preprocessing.dapi_index,
                exclude_bgsub=config.preprocessing.exclude_bgsub,
        ...
        case "attention_heatmaps":
            ...
            attention_heatmap_(
                ...
                masson_trichrome_path=config.attention_heatmaps.masson_trichrome_path,
